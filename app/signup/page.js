...
export default function SignUp() {
  ...
  return (
    <div className="relative min-h-screen bg-[#121212] text-gray-200 pb-10">
      <Navbar />
      <main className="relative flex flex-col items-center justify-center pt-32 px-4 pb-20">
        <div className="relative p-6 rounded-md bg-[#2d2d2d] text-white border border-gray-700 shadow-lg w-full max-w-lg mx-auto">
          ...
          {errorMessage && <p className="text-purple-500 text-center mb-4">{errorMessage}</p>}
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <label htmlFor="termsAndConditions" className="text-gray-300">
                ...
                and{" "}
                <a href="/terms-and-conditions" className="text-purple-500 hover:underline">Terms & Conditions</a>
              </label>
            </div>

            <button
              type="submit"
              className="flex items-center justify-center gap-2 px-4 py-2 bg-transparent border-2 border-purple-500 rounded-full shadow-lg hover:bg-gradient-to-br hover:from-purple-500 hover:to-indigo-600 hover:scale-105 transition-all duration-300 disabled:opacity-50"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-400">
              ...
              <a href="/signin" className="text-purple-500 hover:underline font-semibold">Sign In</a>
            </p>
          </div>
        </div>
      </main>
